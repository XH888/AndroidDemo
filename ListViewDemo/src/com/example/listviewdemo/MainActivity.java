...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		list.add(new DataItem("zhangsan1","男",16));
		list.add(new DataItem("zhangsan2","女",14));
		list.add(new DataItem("zhangsan3","男",14));
		list.add(new DataItem("zhangsan4","女",11));
		list.add(new DataItem("zhangsan5","男",15));
